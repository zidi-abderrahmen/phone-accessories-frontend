...
**Not specified in the current codebase.** The project is marked `"private": true` in `package.json` and no license file is present. If you intend to publish or redistribute this code, add a `LICENSE` file (e.g. MIT) and update this section accordingly.
